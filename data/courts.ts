...
export const courts: Court[] = [
  ...
  },
  {
    ...
    parking: 'Free parking available',
    longDescription: [
      'The Pitch on Burnet Road is Austin\'s most complete sports-and-entertainment complex, and the pickleball courts here are the real deal — not an afterthought bolted onto a bar. Three outdoor courts with proper surfacing and lighting sit at the center of a venue that also includes multiple restaurants, multiple bars, and a coffee shop, all sharing the same footprint. You can play a full set, walk ten feet, and order food or drinks without leaving the property. For groups where not everyone is a pickleball player, it\'s the only Austin venue where the non-players will actually have a good time waiting.',
      'Court rental is $25/hour and reservations are strongly recommended, especially Thursday through Saturday evenings when the venue fills up and walk-in court availability gets unpredictable. Book ahead through their website or call directly. Early morning slots — 7am to 9am on weekdays — are the best-kept secret here: the courts are empty, the temperature is tolerable, and you get the facility to yourself before the entertainment crowd arrives. Weekend afternoons are buzzing but also the most social, with a steady mix of skill levels and a lot of first-timers trying pickleball for the first time.',
      'The crowd at The Pitch skews social over competitive. You\'ll find beginner groups, date-night players, office team outings, and recreational regulars all sharing the same courts on any given evening. Open play is available when courts aren\'t reserved — check the schedule before you go. If you\'re an advanced player looking for serious drilling sessions, the vibe here is more casual than somewhere like Austin Pickle Ranch. But if you want to introduce someone to pickleball in an environment where they\'ll have fun regardless of how the games go, this is the right call.',
      'The Pitch is located at 12000 Burnet Road in North Austin, just north of 183 near the intersection with Metric Boulevard. Free parking on-site. Hours run 7am–10pm Monday through Thursday, 7am–11pm Friday, 8am–11pm Saturday, and 8am–10pm Sunday. The extended Friday and Saturday hours make it a legitimate evening destination. If you\'re coming from central or south Austin, budget 20–25 minutes on 183 North or Mopac depending on traffic. The courts are visible from the main parking lot — walk toward the open-air complex and you\'ll find them.',
    ],
    featured: false
  },
  {
